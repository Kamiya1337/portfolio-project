...
export default function EvidenceTable() {
  ...
  return (
    <div className="page-shell inner-luxury-page evidence-luxury-page">
      {previewData.isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#010404]/94 p-2 sm:p-6 print:hidden" role="dialog" aria-modal="true" aria-label="Xem trước minh chứng">
      ...
      <motion.header initial={reduceMotion ? false : 'hidden'} animate="visible" variants={blurSlideUp} className="inner-page-hero editorial-page-hero motion-depth-section relative overflow-hidden rounded-[30px] border border-cyan-100/[0.1] px-5 py-9 sm:px-9 sm:py-12"><div className="pointer-events-none absolute -right-16 -top-20 h-56 w-56 rounded-full bg-[radial-gradient(circle,rgba(110,231,183,0.1),transparent_68%)]" /><p className="section-label">Evidence control board</p><h1 className="page-heading mt-3 max-w-4xl">Bảng Kiểm soát Minh chứng</h1><p className="page-description">Tổng hợp tình trạng các file báo cáo, hình ảnh và liên kết sản phẩm cần nộp.</p><motion.div initial={reduceMotion ? false : 'hidden'} animate="visible" variants={lineReveal} className="mt-6 h-px origin-left bg-gradient-to-r from-cyan-200/45 via-cyan-100/10 to-transparent" /></motion.header>
